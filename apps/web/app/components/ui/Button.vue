...
const classes = computed(() =>
  cn(
    "inline-flex shrink-0 items-center justify-center gap-1.5 rounded-[6px] font-medium",
    "transition-colors duration-120 disabled:pointer-events-none disabled:opacity-40",
